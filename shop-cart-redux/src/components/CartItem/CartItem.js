...
import { openCartModalAction} from "../../redux/Modals/modal-actions"

const CartItem = ({ item, adjustQty, openCartModal }) => {
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    openCartModal: (item) => dispatch(openCartModalAction(item)),
  };
};
